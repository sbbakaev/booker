<form method="post" action="/user/addUser" id = "newevent">
    1. 	Enter new employee name <br />
    <input type=text name="name" id ="name" maxlen=1><br/>
    2. 	Enter new employee surname <br />
    <input type=text name="surname" id ="surname" maxlen=1><br/>
    3. 	Enter new employee username <br />
    <input type=text name="username" id ="username" maxlen=1><br/>
    4. 	Enter new employee e-mail<br />
    <input type=text name="mail" id ="mail" maxlen=1><br/>
    ...
    <input  type="password" name="password" id ="password" maxlen=1><br/>
